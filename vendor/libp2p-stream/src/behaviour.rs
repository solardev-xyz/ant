...
pub struct Behaviour {
    ...
    /// 1 reproduces upstream's serialised behaviour; ant's perf-lab
    /// A/B sets `ANT_SUBSTREAM_UPGRADE_CAP` to test keyed concurrent
    /// upgrades (Experiment 3).
...
impl Behaviour {
    pub fn new() -> Self {
        ...
        let max_concurrent_upgrades = std::env::var("ANT_SUBSTREAM_UPGRADE_CAP")
            .ok()
